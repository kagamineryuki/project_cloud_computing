						...
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title">The Premium E-learning Platform</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Welcome To We-Learn E-Learning Platform</h2>
						<div class="section_subtitle"><p>We are ready to serve you our best service for helping in your education system</p></div>
					</div>
				</div>
			</div>
			<div class="row features_row">
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Full-time Support</h3>
						<br>
						<div class="feature_text"><p>Our engineers are ready to stay up 24 hours to maintain your education platform</p></div>
					</div>
				</div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Customizable Courses</h3>
						<br>
						<div class="feature_text"><p>Teachers can easily customize their own courses, and can create so many cool stuffs like online test, etc</p></div>
					</div>
				</div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<br>
						<div class="feature_text"><p>Our E-learning platform has a understandable user interface, so it will be easy for people to use</p></div>
					</div>
				</div>
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Certified</h3>
						<br>
						<div class="feature_text"><p>Our E-Learning platform is secured and user's privacies are safe because we don't share user's datas to anyone</p></div>
					</div>
				</div>
	...
	<div class="courses">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Our Service is The Best</h2>
						<div class="section_subtitle"><p>We are grateful to service your school or university. We are trying our best to give our best</p></div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="counter_content">
						<h2 class="counter_title">So, What are you waiting for? Join Us</h2>
						<div class="counter_text"><p>Come and join to our E-Learning platform to help your education system. We provide best services and we have great features to help your education system. </p></div>
						...
						<div class="milestones d-flex flex-md-row flex-column align-items-center justify-content-between">
							...
							<div class="milestone">
								...
								<div class="milestone_text">year</div>
							</div>

							<!-- Milestone -->
							<div class="milestone">
								<div class="milestone_counter" data-end-value="2 000 000" data-sign-after=" IDR">0</div>
								<div class="milestone_text">price</div>
							</div>
				...
				<div class="row fill_height">
					<div class="col fill_height">
						<form class="counter_form_content d-flex flex-column align-items-center justify-content-center" action="#">
							<div class="counter_form_title">Join now</div>
							<input type="text" class="counter_input" placeholder="Your Name:" required="required">
							<input type="tel" class="counter_input" placeholder="Phone:" required="required">
							<input type="tel" class="counter_input" placeholder="School Name:" required="required">
							<button type="submit" class="counter_form_button">Join now</button>
						</form>
					</div>
				</div>
			</div>
	...
	<div class="team">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Our Best Staffs in Town</h2>
						<div class="section_subtitle"><p>These staffs will always be ready to help.</p></div>
					</div>
				</div>
			</div>
			<div class="row team_row">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="images/default-pic.png" alt=""></div>
						<div class="team_body">
							<div class="team_title"><a href="#">Stanislaus Christian Harjanto</a></div>
							<div class="team_subtitle">Server Admin</div>
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="images/default-pic.png" alt=""></div>
						<div class="team_body">
							<div class="team_title"><a href="#">Evander Reinhart Mulyono</a></div>
							<div class="team_subtitle">App Developer</div>
							<div class="social_list">
								<ul>
									<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="images/default-pic.png" alt=""></div>
						<div class="team_body">
							<div class="team_title"><a href="#">Christophorus Reyhan Tantio A</a></div>
							<div class="team_subtitle">App Developer</div>
							<div class="social_list">
								<ul>
									<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="images/default-pic.png" alt=""></div>
						<div class="team_body">
							<div class="team_title"><a href="#">Go, Alexander Alvido Gunawan</a></div>
							<div class="team_subtitle">App Support</div>
							<div class="social_list">
								<ul>
									<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
